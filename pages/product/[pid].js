...
export async function getStaticPaths() {
  ...
  const paths=Object.values(ProductInitialState).map(each=>`/product/${each.id}`)
 
// const paths=["/product/100","/product/101","/product/102","/product/103",]
  ...
  return {
    ...
    // [
    //   { params: {pid:"100"} },
    //   { params: {pid:"101"} }, // See the "paths" section below
    //   { params: {pid:"102"} },
    //   { params: {pid:"103"} }
...
//  return {
//    props: {pid:query.pid}, // will be passed to the page component as props
//  }
// }
...
export default function productDetails({pid}){

// const prod=ProductInitialState
// console.log(prod)
