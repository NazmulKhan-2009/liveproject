...
import { deleteCart, updateProductQuantity } from "../components/CartManagement/cart.actions";
                        ...
                        <tr key={product.id}>
                          ...
                          <td className="quantity-box">
                            <input
                              ...
                              min="1"
                              step="1"
                              onChange={(e)=>dispatch(updateProductQuantity(product.id, e.target.value))}
